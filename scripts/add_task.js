...
(function () {
  ...
  function initAssignedToDropdown() {
    ...
    visibleInput.placeholder = originalSelect.options.length
    ...
    function updateAssignedSelection(visibleEl, listEl) {
      const checked = Array.from(
        listEl.querySelectorAll("input.assigned-checkbox:checked")
      );
    ...
    (function preselectFromOriginal() {
      const originalSelected = Array.from(
        originalSelect.selectedOptions || []
      ).map((o) => o.value);
